      ...
      <div>
        <div>
            ...
            {tenzies && <Confetti/>}
                ...
                <p className='instructions'>A játék célja, hogy minden kocka ugyanazt a számot tartalmazza. 
                A kockákra kattintva megtarthatod az értéket.</p>
                <p className='trying'>Hátralevő idő: <span className='countDown'>{`${minutes}:${seconds < 10 ? '0' : ''}${seconds}`}</span></p>
                
                <p className='trying'>Eddigi próbálkozások száma: <span className='trying-count'>{tryingCount}/20</span></p>
                <div className='container'>
                    ...
                    {tryingCount < maxCount && (tenzies ? 
                        <button 
                        className='btn btn-success roll-button'
